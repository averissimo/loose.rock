...
ggplot.cov.matrix(xdata1) + ggplot2::ggtitle('X1 Covariance Matrix')
#
...
ggplot.cov.matrix(xdata2, fun = cor, method = 'pearson') + ggplot2::ggtitle('X2 Pearson Correlation Matrix')
```
