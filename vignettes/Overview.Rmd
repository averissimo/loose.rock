...
# before running this, remove '../' from ../man/figures/loose.rock_logo.svg" width="120" align="right
...
file.remove(file.path(dirname(getwd()), 'README.html'))
```
